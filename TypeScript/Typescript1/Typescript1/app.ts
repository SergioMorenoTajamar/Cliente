...
let manager = new Manager("Jane", 45, "666666666");
...
//Clases abstractas
//Se usan para definir comportamientos independientemente de la de la concrecion
...
mobProduct.changeName("Super Canon");
console.log(mobProduct);


//Interfaces
//abstracciones que definen un comportamiento
//si se pueden instanciar o heredar
...
//una funcion que reescribe y devuelve el metodo
//constructor de la clase que decora
