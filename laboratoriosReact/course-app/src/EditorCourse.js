...
export class EditorCourse extends Component {
    constructor(props) {
        ...
        this.rules = {
            title: { required: true, minlength: 4, alpha: true },
    ...
    updateFormValue = (event) => {
        ...
        this.setState(
            (prevState) => ({
                ...
                errors: {
                    ...prevState.errors,
                    [name]: prevState.dirty[name] && value.trim() !== "" ? null : prevState.errors[name],
                },
    ...
    render() {
        return (
            <div className="h5 text-white p-3 bg-primary rounded">
                <h2>Add Course</h2>
                <FormValidator
                    data={this.state}
                    rules={this.rules}
