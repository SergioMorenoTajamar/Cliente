...
//2 - Crear un objeto que mapear las function props: saveCallback y deleteCallback
const mapDispatchToProps = {
    saveCallback: saveProduct,
    deleteCallback: deleteProduct
}

//3- Gestionar la funcion connect
const connectFunction = connect(mapStateToProps, mapDispatchToProps);
    //4- Paso final es pasar el componente a la funcion devuelta por connect
